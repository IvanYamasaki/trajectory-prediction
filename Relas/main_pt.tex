...
Ao mesmo tempo, o artigo delimita o alcance dessa infer\^encia. A regress\~ao OLS deve ser lida como an\'alise explorat\'oria complementar, \'util para orientar hip\'oteses e pr\'oximos testes, mas insuficiente para sustentar causalidade. O avan\c{c}o natural a partir daqui \'e construir uma an\'alise com maior granularidade temporal e desenho inferencial mais forte, capaz de avaliar de forma mais direta como a exposi\c{c}\~ao ao drift afeta o erro de predi\c{c}\~ao dos diferentes modelos. Em termos de cr\'edito cient\'ifico, o presente estudo se apoia diretamente na linha inaugurada por Lucas Steuernagel e Marcos M\'aximo~\cite{seq2seq}, estendendo-a do problema de desempenho pontual para o problema de estabilidade temporal.
