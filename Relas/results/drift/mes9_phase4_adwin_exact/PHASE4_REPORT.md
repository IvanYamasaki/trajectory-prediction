...
| PH_agg | 0.0000 | 1 | 2.6000 | 1.0000 | 12 | 0 | Resultado negativo — cobertura 1/5 anos |
    ...
    *Critério de elegibilidade: FAR\_2019\_per1k ≤ 0.2/1k aplicado antes da ordenação.
    ...
    |---------|--------|------------|---------------|------------|
    | ADWIN_S2S | 2.30 | 1.14 | 5/5 | Não |
    | ADWIN_Kalman | 1.80 | 1.12 | 5/5 | Não |
    | OR(ADWIN_S2S, Kalman) | 1.94 | 1.19 | 5/5 | Não |
    ...
    **primário** e o SNR_smooth apenas como desempate final. Limitação reconhecida: o
    ...
    |--------|----------------------|---------------------------|
    | Primeiro alarme em 2021 | índice **~49,275** | índice **~48,290** |
    | Δ₁ (mesmo evento) | — | **-985 trajetórias** |
    | Par mais próximo | PH@78,675 | ADWIN@78,141 |
    | Δ_min (par mais próximo) | — | **534 trajetórias** |
    ...
    | ADWIN_S2S standalone | 8 | 9 | 11 | 9 | 2 | **5/5** |

    ### Sweep W Estendido

| W_coincidence | W_approx_months | n_confirmed | FAR_2019_per1k | year_coverage_confirmed | note |
| --- | --- | --- | --- | --- | --- |
| 50 | 0.0 | 0 | 0.000 | 0 | Δ_min=534 > W=50: sem coincidências |
| 100 | 0.0 | 0 | 0.000 | 0 | Δ_min=534 > W=100: sem coincidências |
| 200 | 0.1 | 0 | 0.000 | 0 | Δ_min=534 > W=200: sem coincidências |
| 500 | 0.1 | 0 | 0.000 | 0 | Δ_min=534 > W=500: sem coincidências |
| 1000 | 0.2 | 2 | 0.000 | 1 | year_coverage_confirmed=1 (só 2021) — PH_agg nunca dispara em 2022-2025 |
| 2000 | 0.5 | 3 | 0.000 | 1 | year_coverage_confirmed=1 (só 2021) — PH_agg nunca dispara em 2022-2025 |
| 5000 | 1.2 | 3 | 0.000 | 1 | year_coverage_confirmed=1 (só 2021) — PH_agg nunca dispara em 2022-2025 |
| 10000 | 2.5 | 5 | 0.000 | 2 | year_coverage_confirmed=2 via pairing cross-ano: ADWIN early-2022 dentro de W=10000 (~2.5 meses) do ultimo PH late-2021 — W operacionalmente absurdo |
| 20000 | 5.0 | 5 | 0.000 | 2 | year_coverage_confirmed=2 via pairing cross-ano: ADWIN early-2022 dentro de W=20000 (~5.0 meses) do ultimo PH late-2021 — W operacionalmente absurdo |
    ...
    **Achado crítico:** year_coverage_confirmed=2 exige W≥10000
    ...
    |---------|----------|----------------|------------|----------------------------------|
    | ADWIN_S2S | 6 | 48,000 | 0.1250 | [0.0573, 0.2727] |
    ...
    **Ensemble AND(ADWIN_S2S, PH_agg): testado, caracterizado e rejeitado.**
    ...
    | `images/and_infeasibility.png` | Figura 300 dpi: desalinhamento ADWIN vs PH (Δ₁=-985, Δ_min=534) |
