...
%  que foram REESCRITOS ou REMOVIDOS em main_double_blind.tex; as marcas [+ ...]
%  em amarelo indicam ONDE material novo foi INSERIDO na versao corrigida.
%  Compare com main_double_blind.tex, onde o texto novo esta grifado.
%
...
% REVISAO: abstract inteiro reescrito (ver main_double_blind.tex).
\begin{abstract}
...
% REVISAO: secao inteira ampliada e reescrita (ver main_double_blind.tex).
